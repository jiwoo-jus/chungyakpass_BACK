...
import com.hanium.chungyakpassback.repository.verification.VerificationOfGeneralKookminRepository;
...
@Service
public class VerificationOfGeneralKookminServiceImpl implements VerificationOfGeneralKookminService {
    ...
    public List<VerificationOfGeneralKookminResponseDto> readGeneralKookminVerifications() {
        ...
        return verificationOfGeneralKookminResponseDtos;
    }

    @Override
    @Transactional(rollbackFor = Exception.class)
    public VerificationOfGeneralKookminResponseDto createGeneralKookminVerification(VerificationOfGeneralKookminDto verificationOfGeneralKookminDto) {
        User user = userRepository.findOneWithAuthoritiesByEmail(SecurityUtil.getCurrentEmail().get()).get();
        ...
        VerificationOfGeneralKookmin verificationOfGeneralKookmin = new VerificationOfGeneralKookmin(user, americanAge, meetLivingInSurroundAreaTf, accountTf, meetHomelessHouseholdMembersTf, householderTf, meetAllHouseMemberNotWinningIn5yearsTf, meetAllHouseMemberRewinningRestrictionTf, meetBankbookJoinPeriodTf, meetNumberOfPaymentsTf, isRestrictedAreaTf, aptInfo, aptInfoTarget);
        verificationOfGeneralKookminRepository.save(verificationOfGeneralKookmin);
        return new VerificationOfGeneralKookminResponseDto(verificationOfGeneralKookmin);
    }
