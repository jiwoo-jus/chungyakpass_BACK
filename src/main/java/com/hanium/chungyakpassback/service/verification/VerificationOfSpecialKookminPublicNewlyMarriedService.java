...
public interface VerificationOfSpecialKookminPublicNewlyMarriedService {

    List<VerificationOfSpecialKookminPublicNewlyMarriedResponseDto> readSpecialKookminPublicNewlyMarriedVerifications(); //특별신혼부부국민조회

    VerificationOfSpecialKookminPublicNewlyMarriedResponseDto createSpecialKookminPublicNewlyMarriedVerification(VerificationOfSpecialKookminPublicNewlyMarriedDto verificationOfSpecialKookminPublicNewlyMarriedDto); //특별신혼부부공특법적용저장

    VerificationOfSpecialKookminPublicNewlyMarriedResponseDto updateSpecialKookminPublicNewlyMarriedVerification(Long verificationRecordSpecialKookminNewlyMarriedId, VerificationOfSpecialKookminPublicNewlyMarriedUpdateDto verificationOfSpecialKookminPublicNewlyMarriedUpdateDto); //특별신혼부부공특법적용업데이트
