...
public interface VerificationOfSpecialMinyeongNewlyMarriedService {

    List<VerificationOfSpecialMinyeongNewlyMarriedResponseDto> readSpecialMinyeongNewlyMarriedVerifications(); //특별신혼부부민영조회

    VerificationOfSpecialMinyeongNewlyMarriedResponseDto createSpecialMinyeongNewlyMarriedVerification(VerificationOfSpecialMinyeongNewlyMarriedDto verificationOfSpecialMinyeongNewlyMarriedDto); //특별신혼부부민영저장

    VerificationOfSpecialMinyeongNewlyMarriedResponseDto updateSpecialMinyeongNewlyMarriedVerification(Long verificationRecordSpecialMinyeongNewlyMarriedId, VerificationOfSpecialMinyeongNewlyMarriedUpdateDto verificationOfSpecialMinyeongNewlyMarriedUpdateDto); //특별신혼부부민영업데이트
