...
import com.hanium.chungyakpassback.repository.verification.VerificationOfSpecialKookminFirstLifeRepository;
...
@Service
public class VerificationOfSpecialKookminPublicFirstLifeServiceImpl implements VerificationOfSpecialKookminPublicFirstLifeService {
    ...
    public List<VerificationOfSpecialKookminPublicFirstLifeResponseDto> readSpecialKookminFirstLifeVerifications() {
        ...
        return verificationOfSpecialKookminPublicFirstLifeResponseDtos;
    }

    @Override
    @Transactional(rollbackFor = Exception.class)
    public VerificationOfSpecialKookminPublicFirstLifeResponseDto createSpecialKookminPublicFirstLifeVerification(VerificationOfSpecialKookminPublicFirstLifeDto verificationOfSpecialKookminPublicFirstLifeDto) {
        User user = userRepository.findOneWithAuthoritiesByEmail(SecurityUtil.getCurrentEmail().get()).get();
        ...
        VerificationOfSpecialKookminFirstLife verificationOfSpecialKookminFirstLife = new VerificationOfSpecialKookminFirstLife(user, americanAge, meetLivingInSurroundAreaTf, accountTf, meetRecipientTf, meetMonthlyAverageIncomePriorityTf, meetMonthlyAverageIncomeGeneralTf, meetPropertyTf, meetHomelessHouseholdMembersTf, householderTf, meetAllHouseMemberNotWinningIn5yearsTf, meetAllHouseMemberRewinningRestrictionTf, meetBankbookJoinPeriodTf, meetNumberOfPaymentsTf, isRestrictedAreaTf, aptInfo, aptInfoTarget);
        verificationOfSpecialKookminFirstLifeRepository.save(verificationOfSpecialKookminFirstLife);
    ...
    public VerificationOfSpecialKookminPublicFirstLifeResponseDto updateSpecialKookminPublicFirstLifeVerification(Long id, VerificationOfSpecialKookminPublicFirstLifeUpdateDto verificationOfSpecialKookminPublicFirstLifeUpdateDto) {
        ...
        verificationOfSpecialKookminFirstLife.setFirstRankHistoryYn(verificationOfSpecialKookminPublicFirstLifeUpdateDto.getFirstRankHistoryYn());
        verificationOfSpecialKookminFirstLife.setRanking(verificationOfSpecialKookminPublicFirstLifeUpdateDto.getRanking());
        verificationOfSpecialKookminFirstLifeRepository.save(verificationOfSpecialKookminFirstLife);
        return new VerificationOfSpecialKookminPublicFirstLifeResponseDto(verificationOfSpecialKookminFirstLife);
    }
