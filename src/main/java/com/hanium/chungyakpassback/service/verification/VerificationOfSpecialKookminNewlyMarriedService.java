...
public interface VerificationOfSpecialKookminNewlyMarriedService {
    ...
    VerificationOfSpecialKookminNewlyMarriedResponseDto createSpecialKookminNewlyMarriedVerification(VerificationOfSpecialKookminNewlyMarriedDto verificationOfSpecialKookminNewlyMarriedDto); //특별신혼부부국민저장

    VerificationOfSpecialKookminNewlyMarriedResponseDto updateSpecialKookminNewlyMarriedVerification(Long verificationRecordSpecialKookminNewlyMarriedId, VerificationOfSpecialKookminNewlyMarriedUpdateDto verificationOfSpecialKookminNewlyMarriedUpdateDto); //특별신혼부부국민업데이트
