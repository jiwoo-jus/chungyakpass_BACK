...
public interface VerificationOfSpecialKookminPublicOldParentService {
    ...
    List<VerificationOfSpecialKookminPublicOldParentResponseDto> readSpecialKookminOldParentVerifications();

    VerificationOfSpecialKookminPublicOldParentResponseDto createSpecialKookminPublicOldParentVerification(VerificationOfSpecialKookminPublicOldParentDto verificationOfSpecialKookminPublicOldParentDto);

    VerificationOfSpecialKookminPublicOldParentResponseDto updateSpecialKookminPublicOldParentVerification(Long verificationRecordSpecialKookminOldParentId, VerificationOfSpecialKookminPublicOldParentUpdateDto verificationOfSpecialKookminPublicOldParentUpdateDto);
