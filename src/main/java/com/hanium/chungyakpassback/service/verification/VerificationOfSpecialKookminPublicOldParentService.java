...
public interface VerificationOfSpecialKookminPublicOldParentService {

    List<VerificationOfSpecialKookminPublicOldParentResponseDto> readSpecialKookminOldParentVerifications(); //특별노부부국민조회

    VerificationOfSpecialKookminPublicOldParentResponseDto createSpecialKookminPublicOldParentVerification(VerificationOfSpecialKookminPublicOldParentDto verificationOfSpecialKookminPublicOldParentDto); //특별노부부국민저장

    VerificationOfSpecialKookminPublicOldParentResponseDto updateSpecialKookminPublicOldParentVerification(Long verificationRecordSpecialKookminOldParentId, VerificationOfSpecialKookminPublicOldParentUpdateDto verificationOfSpecialKookminPublicOldParentUpdateDto); //특별노부부국민업데이트
