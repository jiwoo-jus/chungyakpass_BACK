...
import com.hanium.chungyakpassback.repository.verification.VerificationOfSpecialMinyeongNewlyMarriedRepository;
...
@Service
public class VerificationOfSpecialMinyeongNewlyMarriedServiceImpl implements VerificationOfSpecialMinyeongNewlyMarriedService {
    ...
    public List<VerificationOfSpecialMinyeongNewlyMarriedResponseDto> readSpecialMinyeongNewlyMarriedVerifications() {
        ...
        return verificationOfSpecialMinyeongNewlyMarriedResponseDtos;
    }

    @Override
    @Transactional(rollbackFor = Exception.class)
    public VerificationOfSpecialMinyeongNewlyMarriedResponseDto createSpecialMinyeongNewlyMarriedVerification(VerificationOfSpecialMinyeongNewlyMarriedDto verificationOfSpecialMinyeongNewlyMarriedDto) {
        User user = userRepository.findOneWithAuthoritiesByEmail(SecurityUtil.getCurrentEmail().get()).get();
        ...
        VerificationOfSpecialMinyeongNewlyMarried verificationOfSpecialMinyeongNewlyMarried = new VerificationOfSpecialMinyeongNewlyMarried(user, americanAge, meetLivingInSurroundAreaTf, accountTf, meetMonthlyAverageIncomePriorityTf, meetMonthlyAverageIncomeGeneralTf, meetMarriagePeriodIn7yearsTf, hasMinorChildren, meetHomelessHouseholdMembersTf, meetAllHouseMemberRewinningRestrictionTf, householderTf, meetBankbookJoinPeriodTf, meetDepositTf, isRestrictedAreaTf, secondChungyak, aptInfo, aptInfoTarget);
