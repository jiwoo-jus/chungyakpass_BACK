...
import com.hanium.chungyakpassback.repository.verification.VerificationOfSpecialKookminOldParentRepository;
...
@Service
public class VerificationOfSpecialKookminPublicOldParentServiceImpl implements VerificationOfSpecialKookminPublicOldParentService {
    ...
    public List<VerificationOfSpecialKookminPublicOldParentResponseDto> readSpecialKookminOldParentVerifications() {
        ...
        return verificationOfSpecialKookminPublicOldParentResponseDtos;
    }

    @Override
    @Transactional(rollbackFor = Exception.class)
    public VerificationOfSpecialKookminPublicOldParentResponseDto createSpecialKookminPublicOldParentVerification(VerificationOfSpecialKookminPublicOldParentDto verificationOfSpecialKookminPublicOldParentDto) {
        User user = userRepository.findOneWithAuthoritiesByEmail(SecurityUtil.getCurrentEmail().get()).get();
        ...
        VerificationOfSpecialKookminOldParent verificationOfSpecialKookminOldParent = new VerificationOfSpecialKookminOldParent(user, americanAge, meetLivingInSurroundAreaTf, accountTf, meetMonthlyAverageIncome, meetPropertyTf, meetOldParentSupportMore3yearsTf, meetHomelessHouseholdMembersTf, householderTf, isRestrictedAreaTf, meetAllHouseMemberNotWinningIn5yearsTf, meetAllHouseMemberRewinningRestrictionTf, meetBankbookJoinPeriodTf, meetNumberOfPaymentsTf, aptInfo, aptInfoTarget);
        verificationOfSpecialKookminOldParentRepository.save(verificationOfSpecialKookminOldParent);
    ...
    @Override
    @Transactional(rollbackFor = Exception.class) //청약통장유형충족여부
