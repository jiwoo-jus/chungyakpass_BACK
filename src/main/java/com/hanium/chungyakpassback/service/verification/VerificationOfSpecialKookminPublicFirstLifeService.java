...
public interface VerificationOfSpecialKookminPublicFirstLifeService {
    ...
    List<VerificationOfSpecialKookminPublicFirstLifeResponseDto> readSpecialKookminFirstLifeVerifications(); //특별생애최초국민조회

    VerificationOfSpecialKookminPublicFirstLifeResponseDto createSpecialKookminPublicFirstLifeVerification(VerificationOfSpecialKookminPublicFirstLifeDto verificationOfSpecialKookminPublicFirstLifeDto); //특별생애최초국민저장

    VerificationOfSpecialKookminPublicFirstLifeResponseDto updateSpecialKookminPublicFirstLifeVerification(Long verificationRecordSpecialKookminFirstLifeId, VerificationOfSpecialKookminPublicFirstLifeUpdateDto verificationOfSpecialKookminPublicFirstLifeUpdateDto); //특별생애최초국민업데이트
