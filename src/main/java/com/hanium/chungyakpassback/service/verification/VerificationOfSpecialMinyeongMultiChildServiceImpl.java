...
import com.hanium.chungyakpassback.repository.verification.VerificationOfSpecialMinyeongMultiChildRepository;
...
@Service
public class VerificationOfSpecialMinyeongMultiChildServiceImpl implements VerificationOfSpecialMinyeongMultiChildService {
    ...
    @Override //특별다자녀민영조회
    public List<VerificationOfSpecialMinyeongMultiChildResponseDto> readSpecialMinyeongMultiChildVerifications() {
        ...
        return verificationOfSpecialMinyeongMultiChildResponseDtos;
    }

    @Override
    @Transactional(rollbackFor = Exception.class)
    public VerificationOfSpecialMinyeongMultiChildResponseDto createSpecialMinyeongMultiChildVerification(VerificationOfSpecialMinyeongMultiChildDto verificationOfSpecialMinyeongMultiChildDto) {
        User user = userRepository.findOneWithAuthoritiesByEmail(SecurityUtil.getCurrentEmail().get()).get();
        HouseMember houseMember = user.getHouseMember();
        AptInfo aptInfo = aptInfoRepository.findById(verificationOfSpecialMinyeongMultiChildDto.getNotificationNumber()).orElseThrow(() -> new CustomException(ErrorCode.NOT_FOUND_APT));
        AptInfoTarget aptInfoTarget = aptInfoTargetRepository.findByResidentialAreaAndAptInfo(verificationOfSpecialMinyeongMultiChildDto.getResidentialArea(), aptInfo).orElseThrow(() -> new CustomException(ErrorCode.NOT_FOUND_APT));
        ...
        VerificationOfSpecialMinyeongMultiChild verificationOfSpecialMinyeongMultiChild = new VerificationOfSpecialMinyeongMultiChild(user, americanAge, meetLivingInSurroundAreaTf, accountTf, meetHomelessHouseholdMembersTf, meetAllHouseMemberRewinningRestrictionTf, calcMinorChildren, householderTf, isRestrictedAreaTf, meetHouseHavingLessThan2Apt, isPriorityApt, meetBankbookJoinPeriodTf, meetDepositTf, aptInfo, aptInfoTarget);
        verificationOfSpecialMinyeongMultiChildRepository.save(verificationOfSpecialMinyeongMultiChild);
        return new VerificationOfSpecialMinyeongMultiChildResponseDto(verificationOfSpecialMinyeongMultiChild);
    }
