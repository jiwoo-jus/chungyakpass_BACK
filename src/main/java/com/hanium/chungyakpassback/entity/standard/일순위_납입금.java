...
import com.hanium.chungyakpassback.entity.enumtype.예치금액지역구분;
import lombok.*;
...
public class 일순위_납입금 {
    ...
    @Builder
    public 일순위_납입금(Integer 면적_초과, Integer 면적_이하, com.hanium.chungyakpassback.entity.enumtype.예치금액지역구분 예치금액지역구분, int 예치금액) {
        this.면적_초과 = 면적_초과;
        this.면적_이하 = 면적_이하;
