...
public class RecordSpecialMinyeongPointOfSingleParents extends BaseTime {
    ...
    @Builder
    public RecordSpecialMinyeongPointOfSingleParents(User user, AptInfo aptInfo, Integer numberOfMinors, Integer ageOfMostYoungChild, Integer bankbookPaymentsCount, Integer periodOfApplicableAreaResidence ,Integer monthOfAverageIncome,Integer total) {
        this.user = user;
