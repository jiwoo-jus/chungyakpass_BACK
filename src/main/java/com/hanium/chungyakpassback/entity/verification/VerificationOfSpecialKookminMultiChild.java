...
@Table(name = "verification_of_special_kookmin_multi_child")
public class VerificationOfSpecialKookminMultiChild extends BaseTime {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "verification_of_special_kookmin_multi_child_id")
    private Long id;
...
//    private AptInfoTarget aptInfoTarget; //주택형
    ...
    @Builder
    public VerificationOfSpecialKookminMultiChild(User user, Integer americanAge, boolean meetLivingInSurroundAreaTf, boolean accountTf, boolean meetMonthlyAverageIncome, boolean meetPropertyTf, boolean meetHomelessHouseholdMemberTf, boolean meetAllHouseMemberRewinningRestrictionTf, Integer calcMinorChildren, boolean householderTf, boolean meetBankbookJoinPeriodTf, boolean meetNumberOfPaymentsTf, boolean restrictedAreaTf, AptInfo aptInfo, AptInfoTarget aptInfoTarget) {
        this.user = user;
