...
public class VerificationRecordSpecialMinyeongMultiChild extends BaseTime {
    ...
    @Builder
    public VerificationRecordSpecialMinyeongMultiChild(User user, Integer americanAge, boolean meetLivingInSurroundAreaTf, boolean accountTf, boolean meetHomelessHouseholdMemberTf, boolean meetAllHouseMemberRewinningRestrictionTf, Integer calcMinorChildren, boolean householderTf, boolean restrictedAreaTf, boolean meetHouseHavingLessThan2AptTf, boolean priorityApt, boolean meetBankbookJoinPeriodTf, boolean meetDepositTf, AptInfo aptInfo, AptInfoTarget aptInfoTarget) {
        this.user = user;
