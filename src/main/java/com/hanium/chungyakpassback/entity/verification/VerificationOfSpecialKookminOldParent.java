...
@Table(name = "verification_of_special_kookmin_old_parent")
public class VerificationOfSpecialKookminOldParent extends BaseTime {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "verification_of_special_kookmin_old_parent_id")
    private Long id;
    ...
    @Builder
    public VerificationOfSpecialKookminOldParent(User user, Integer americanAge, boolean meetLivingInSurroundAreaTf, boolean accountTf, boolean meetMonthlyAverageIncome, boolean meetPropertyTf, boolean meetOldParentSupportMore3yearsTf, boolean meetHomelessHouseholdMemberTf, boolean householderTf, boolean restrictedAreaTf, boolean meetAllHouseMemberNotWinningIn5yearsTf, boolean meetAllHouseMemberRewinningRestrictionTf, boolean meetBankbookJoinPeriodTf, boolean meetNumberOfPaymentsTf, AptInfo aptInfo, AptInfoTarget aptInfoTarget) {
        this.user = user;
