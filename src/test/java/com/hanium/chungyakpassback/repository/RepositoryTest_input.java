...
//
//        Household Household1 = new Household(주소1);
//        Household Household2 = new Household(주소1);
//        Household Household3 = new Household(주소2);
//
//        //필수 필드만 build, 나머지는 setter 이용
//        세대구성원 세대구성원1 = 세대구성원.builder().세대(Household1).세대주여부(여부.y).이름("장윤정").build();
//        세대구성원 세대구성원2 = 세대구성원.builder().세대(Household3).세대주여부(여부.y).이름("도경완").build();
//        세대구성원 세대구성원3 = 세대구성원.builder().세대(Household1).세대주여부(여부.n).이름("도연우").build();
//        세대구성원1.set세대구성원배우자(세대구성원2);
//        세대구성원2.set세대구성원배우자(세대구성원1);
//        //전체 필드 대상 build
//        세대구성원 세대구성원4 = 세대구성원.builder().세대(Household2).세대주여부(여부.y).이름("이효리").생년월일(LocalDate.of(1985, 03, 12)).build();
//        세대구성원 세대구성원5 = 세대구성원.builder().세대(Household2).이름("이상순").세대주여부(여부.n).build();
