...
//        Household Household1 = Household.builder().주소(주소1).build();
//        Household Household2 = Household.builder().주소(주소2).build();
//        세대구성원 세대구성원1 = 세대구성원.builder().세대(Household1).세대주여부(여부.y).이름("장윤정").생년월일(LocalDate.of(1980, 2, 16)).외국인여부(여부.n).장기복무군인여부(여부.y).혼인신고일(LocalDate.of(2013, 5, 5)).전입신고일(LocalDate.of(2005, 1, 1)).build();
//        세대구성원 세대구성원2 = 세대구성원.builder().세대(Household2).세대주여부(여부.y).이름("도경완").생년월일(LocalDate.of(1982, 3, 7)).외국인여부(여부.n).장기복무군인여부(여부.y).혼인신고일(LocalDate.of(2013, 5, 5)).전입신고일(LocalDate.of(2012, 1, 1)).build();
//        세대구성원1.set세대구성원배우자(세대구성원2);
//        세대구성원2.set세대구성원배우자(세대구성원1);
//        세대구성원 세대구성원3 = 세대구성원.builder().세대(Household1).세대주여부(여부.n).이름("육흥복").생년월일(LocalDate.of(1956, 3, 5)).외국인여부(여부.n).장기복무군인여부(여부.y).혼인신고일(LocalDate.of(1978, 1, 1)).전입신고일(LocalDate.of(2007, 1, 1)).build();
//        세대구성원 세대구성원4 = 세대구성원.builder().세대(Household2).세대주여부(여부.n).이름("장동수").생년월일(LocalDate.of(1951, 5, 5)).외국인여부(여부.n).장기복무군인여부(여부.y).혼인신고일(LocalDate.of(1978, 1, 1)).전입신고일(LocalDate.of(2012, 1, 1)).build();
//        세대구성원 세대구성원5 = 세대구성원.builder().세대(Household2).세대주여부(여부.n).이름("도연우").생년월일(LocalDate.of(2014, 6, 13)).외국인여부(여부.n).장기복무군인여부(여부.y).전입신고일(LocalDate.of(2014, 6, 15)).build();
//        세대구성원 세대구성원6 = 세대구성원.builder().세대(Household2).세대주여부(여부.n).이름("도하영").생년월일(LocalDate.of(2018, 11, 9)).외국인여부(여부.n).장기복무군인여부(여부.y).전입신고일(LocalDate.of(2018, 11, 10)).build();
